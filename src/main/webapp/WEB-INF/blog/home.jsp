<%@ page language="java"
	import="java.util.*, java.net.URLEncoder, com.blog.model.*"
	pageEncoding="UTF-8"%>
...
<body id="contain" class="home blog ui-c3">
	...
	<form method="get" class="degfy_search_box">
		<input class="degfy_search_input" name="keyword" type="text"
	...
	<script type="text/javascript"
		src="<%=basePath%>js/article/article_list.js"></script>
