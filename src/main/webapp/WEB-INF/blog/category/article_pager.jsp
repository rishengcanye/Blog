...
<title>${ca.categoryName}</title>
<meta name="description" content="${ca.categoryName}" />
<meta name="keywords" content="${ca.categoryName}" />
<style type="text/css">
...
<body id="contain" class="home blog ui-c3">
	...
	<ul class="nav">
		...
		<li
			...
			<a href="<%=basePath%>"> <span class="glyphicon glyphicon-book"></span>首页
		</a>
		</li>
		<c:forEach items="${categoryList}" var="category">
			<li
				class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-61  
				<c:if test="${ca.id == category.id}">current_page_item </c:if>
				"><a
				href="<%=basePath%>category/${category.aliasName}"> <span
	...
	<script type="text/javascript"
		src="<%=basePath%>js/category/category_article_list.js"></script>
